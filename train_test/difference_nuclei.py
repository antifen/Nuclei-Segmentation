...
'''
To flag segmentation and mask difference use color of Green Red and Blue 
'''
...
def retina_color_different(predicts, gts, pathsave):
    ...
    # print('new color image shape is: ',new_color_retina.shape)
    visualize(new_color_retina, pathsave)
    return new_color_retina


if __name__ == '__main__':
    pathpre = './tempt/10.png'        # 注意： 分割之后的概率图，值是 0-1之间
    pathgt = './tempt/10_label.png'   # 对应的ground-truth
    pathsave = '../tempt/10_comp'     # 差异图保存路径
    retina_color(pathpre, pathgt, pathsave)  #方法
